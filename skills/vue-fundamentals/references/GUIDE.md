# Vue Fundamentals Guide

## Overview

This guide provides comprehensive documentation for the **vue-fundamentals** skill in the custom-plugin-vue plugin.
...
```bash
# Invoke the skill
claude "vue-fundamentals - [your task description]"

# Example
claude "vue-fundamentals - analyze the current implementation"
```
...
def implement_vue_fundamentals(input_data):
    """
    Implement vue-fundamentals functionality.
