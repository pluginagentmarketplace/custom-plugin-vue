...
This guide provides comprehensive documentation for the **vue-typescript** skill in the custom-plugin-vue plugin.
...
```bash
# Invoke the skill
claude "vue-typescript - [your task description]"

# Example
claude "vue-typescript - analyze the current implementation"
```
...
def implement_vue_typescript(input_data):
    """
    Implement vue-typescript functionality.
