...
This guide provides comprehensive documentation for the **vue-pinia** skill in the custom-plugin-vue plugin.
...
```bash
# Invoke the skill
claude "vue-pinia - [your task description]"

# Example
claude "vue-pinia - analyze the current implementation"
```
...
def implement_vue_pinia(input_data):
    """
    Implement vue-pinia functionality.
