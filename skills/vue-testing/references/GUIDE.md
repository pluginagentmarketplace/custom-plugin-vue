...
This guide provides comprehensive documentation for the **vue-testing** skill in the custom-plugin-vue plugin.
...
```bash
# Invoke the skill
claude "vue-testing - [your task description]"

# Example
claude "vue-testing - analyze the current implementation"
```
...
def implement_vue_testing(input_data):
    """
    Implement vue-testing functionality.
