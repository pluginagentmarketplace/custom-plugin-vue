...
This guide provides comprehensive documentation for the **vue-router** skill in the custom-plugin-vue plugin.
...
```bash
# Invoke the skill
claude "vue-router - [your task description]"

# Example
claude "vue-router - analyze the current implementation"
```
...
def implement_vue_router(input_data):
    """
    Implement vue-router functionality.
